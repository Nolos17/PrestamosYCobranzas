    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Reporte de Préstamos</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <!-- Botón para Mensual -->
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-primary w-100"
                                onclick="mostrarSelect('mensual', 'prestamos')">
                        ...
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-primary w-100"
                                onclick="mostrarSelect('anual', 'prestamos')">
                                <img src="{{ asset('img/año.gif') }}" class="icon-img" alt="Anual"> Anual
                            </button>
                        </div>
                        <!-- Enlace directo para Global -->
                        <div class="col-4">
                            <a href="{{ url('/admin/reportes/prestamos2?tipo_reporte=global') }}"
                    ...
                    <form id="form-mensual-prestamos" action="{{ url('/admin/reportes/prestamos1') }}" method="GET"
                        target="_blank" style="display: none;">
                        <input type="hidden" name="tipo_reporte" value="mensual">
                        <div class="form-group">
                            <label for="mes_prestamos">Seleccione el mes:</label>
                            <select name="mes" id="mes_prestamos" class="form-control">
                        ...
                        <button type="submit" class="btn btn-primary btn-block">Generar Mensual</button>
                    </form>

                    <!-- Formulario para Anual -->
                    <form id="form-anual-prestamos" action="{{ url('/admin/reportes/prestamos2') }}" method="GET"
                        target="_blank" style="display: none;">
                        <input type="hidden" name="tipo_reporte" value="anual">
                        <div class="form-group">
                            <label for="anio_prestamos">Seleccione el año:</label>
                            <select name="anio" id="anio_prestamos" class="form-control">
                                @for ($year = $anioActual; $year >= 2010; $year--)
                                    <option value="{{ $year }}">{{ $year }}</option>
                                @endfor
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary btn-block">Generar Anual</button>
                    </form>

                    <div class="text-center mt-3">
                        <b>{{ $total_prestamos }} Préstamos</b>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card card-outline card-success">
                <div class="card-header">
                    <h3 class="card-title">Reporte de Ahorros</h3>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-primary w-100"
                                onclick="mostrarSelect('mensual', 'ahorros')">
                                <img src="{{ asset('img/mes.gif') }}" class="icon-img" alt="Mensual"> Mensual
                            </button>
                        </div>
                        <div class="col-4">
                            <button type="button" class="btn btn-outline-primary w-100"
                                onclick="mostrarSelect('anual', 'ahorros')">
                                <img src="{{ asset('img/año.gif') }}" class="icon-img" alt="Anual"> Anual
                            </button>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('/admin/reportes/ahorros1?tipo_reporte=global') }}"
                                class="btn btn-outline-primary w-100" target="_blank">
                                <img src="{{ asset('img/lupa_global.gif') }}" class="icon-img" alt="Global"> Global
                            </a>
                        </div>
                    ...
                    <form id="form-mensual-ahorros" action="{{ url('/admin/reportes/ahorros1') }}" method="GET"
                        target="_blank" style="display: none;">
                        <input type="hidden" name="tipo_reporte" value="mensual">
                        <div class="form-group">
                            <label for="mes_ahorros">Seleccione el mes:</label>
                            <select name="mes" id="mes_ahorros" class="form-control">
                                @foreach ($meses as $value => $nombre)
                                    <option value="{{ $anioActual }}-{{ $value }}">
                                        {{ $nombre }} {{ $anioActual }}
                                    </option>
                    ...
                    <form id="form-anual-ahorros" action="{{ url('/admin/reportes/ahorros1') }}" method="GET"
                        target="_blank" style="display: none;">
                        <input type="hidden" name="tipo_reporte" value="anual">
                        <div class="form-group">
                            <label for="anio_ahorros">Seleccione el año:</label>
                            <select name="anio" id="anio_ahorros" class="form-control">
                                @for ($year = $anioActual; $year >= 2010; $year--)
                                    <option value="{{ $year }}">{{ $year }}</option>
                                @endfor
                            </select>
