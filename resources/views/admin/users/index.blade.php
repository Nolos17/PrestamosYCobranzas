        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ url('/admin/users/create') }}" class="btn btn-primary">Crear Nuevo</a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <form action="{{ url('/admin/users/' . $user->id) }}" method="post" id="miFormulario{{ $user->id }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-danger btn-sm" style="border-radius: 0px 4px 4px 0px"
                                            onclick='preguntar("{{ $user->id }}");'>
